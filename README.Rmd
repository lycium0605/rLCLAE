...
From here, rLCLAE has four major steps: 1) calculating genotype likelihood, 2) calculating ancestral allele frequency, 3) calculating ancestral likelihood for test individuals, 4) calling ancestry and 5) generating ancestral tract.
